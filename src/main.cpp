...
unsigned int nStakeMinAge =  60 * 60 * 6;	// minimum age for coin age: 1d
...
int64 nChainStartTime = 1399375539;
...
const string strMessageMagic = "chakracoin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in chakracoin
    bool fStrictPayToScriptHash = true; // Always active in chakracoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "chakracoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Chakracoin Developers 1399375539";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0x5141d98a5613cf3cbb6148087cdc97ad5213940169681487228435e8e73c8fc0"));
